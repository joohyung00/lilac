...
from src.basic_class.document import MultimodalDocument
from src.basic_class.component import Component, get_highest_component_id
...
if __name__ == "__main__":
    ...
    multimodal_documents_dir    = "/root/LILaC/datasets/MMCoQA/parsed_documents/dev"
    images_dir                  = "/root/LILaC/datasets/MMCoQA/image_components/dev"
    subimages_dir               = "/root/LILaC/datasets/MMCoQA/subimage_components/dev"
    summaries_dir               = "/root/LILaC/datasets/MMCoQA/image_summaries/dev"
