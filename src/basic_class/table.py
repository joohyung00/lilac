...
if __name__ == "__main__":
    ...
    TARGET_PATH = "/root/LILaC/datasets/MMWebQA/parsed_documents/dev/2017_Major_League_Baseball_season.json"
    ...
    table = Table(
        ...
        images_dir          = "/root/LILaC/datasets/MMWebQA/image_components/dev",
        image_summaries_dir = "/root/LILaC/datasets/MMWebQA/image_summaries/dev"
    )
