...
class HtmlParser:
    ...
    def __init__(self, args, config):
        ...
        self._htmls_directory       = os.path.join(dataset_directory, config["htmls_dirname"], "val")
        self._parsed_documents_path = os.path.join(dataset_directory, config["parsed_documents_dirname"], "val")  
