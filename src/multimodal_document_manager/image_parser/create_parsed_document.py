...
DATASET_DICT = {
    "InfoVQA":  "/root/LILaC/datasets/InfoVQA",
    "MPDocVQA": "/root/LILaC/datasets/MP-DocVQA",
    "SlideVQA": "/root/LILaC/datasets/SlideVQA"
}
...
def main():
    ...
    model = Qwen2_5_VLForConditionalGeneration.from_pretrained(
        "/root/LILaC/Models/Qwen2.5-VL-7B-Instruct", torch_dtype="auto", device_map="auto"
    )

    # default processer
    processor = AutoProcessor.from_pretrained("/root/LILaC/Models/Qwen2.5-VL-7B-Instruct")
